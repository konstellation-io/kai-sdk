...
func (suite *SdkMessagingTestSuite) TestMessaging_SendEarlyReply_ExpectOk() {
	// Given
...
func (suite *SdkMessagingTestSuite) TestMessaging_SendEarlyReplyWithExistingRequestMessage_ExpectOk() {
	// Given
	viper.SetDefault("nats.output", "test-parent")
	...
	suite.jetstream.AssertCalled(suite.T(),
		"Publish", "test-parent",
		getOutputMessage("123", &msg, "", "parent-node", kai.MessageType_EARLY_REPLY))
}

func (suite *SdkMessagingTestSuite) TestMessaging_SendEarlyReply_WithCompression_ExpectOk() {
	// Given
	viper.SetDefault("nats.output", "test-parent")
	viper.SetDefault("metadata.process_id", "parent-node")
	suite.jetstream.On("Publish", mock.AnythingOfType("string"), mock.AnythingOfType("[]uint8")).
...
func (suite *SdkMessagingTestSuite) TestMessaging_SendEarlyReply_WithCompression_MessageToBig_ExpectError() {
	// Given
	viper.SetDefault("nats.output", "test-parent")
	viper.SetDefault("metadata.process_id", "parent-node")
	suite.jetstream.On("Publish", mock.AnythingOfType("string"), mock.AnythingOfType("[]uint8")).
...
func (suite *SdkMessagingTestSuite) TestMessaging_SendEarlyReplyToSubtopic_ExpectOk() {
	// Given
	viper.SetDefault("nats.output", "test-parent")
	viper.SetDefault("metadata.process_id", "parent-node")
	suite.jetstream.On("Publish", mock.AnythingOfType("string"), mock.AnythingOfType("[]uint8")).
...
func (suite *SdkMessagingTestSuite) TestMessaging_SendEarlyReply_ErrorOnMaxMessageSize_ExpectError() {
	// Given
	viper.SetDefault("nats.output", "test-parent")
	viper.SetDefault("metadata.process_id", "parent-node")
	suite.jetstream.On("Publish", mock.AnythingOfType("string"), mock.AnythingOfType("[]uint8")).
...
func (suite *SdkMessagingTestSuite) TestMessaging_SendEarlyReply_ErrorOnPublish_ExpectError() {
	// Given
	viper.SetDefault("nats.output", "test-parent")
	viper.SetDefault("metadata.process_id", "parent-node")
	suite.jetstream.On("Publish", mock.AnythingOfType("string"), mock.AnythingOfType("[]uint8")).
