...
// MetadataMock_GetObjectStoreName_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'GetEphemeralStorageName'
...
func (_e *MetadataMock_Expecter) GetObjectStoreName() *MetadataMock_GetObjectStoreName_Call {
	return &MetadataMock_GetObjectStoreName_Call{Call: _e.mock.On("GetEphemeralStorageName")}
}
