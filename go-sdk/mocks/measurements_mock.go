...
import (
	measurement "github.com/konstellation-io/kai-sdk/go-sdk/sdk/measurement"
...
func (_m *MeasurementsMock) GetMetricsClient() measurement.MetricsObjectClient {
	ret := _m.Called()

	var r0 measurement.MetricsObjectClient
	if rf, ok := ret.Get(0).(func() measurement.MetricsObjectClient); ok {
		r0 = rf()
	} else {
		r0 = ret.Get(0).(measurement.MetricsObjectClient)
	}
...
func (_c *MeasurementsMock_GetMetricsClient_Call) Return(_a0 measurement.MetricsObjectClient) *MeasurementsMock_GetMetricsClient_Call {
	_c.Call.Return(_a0)
	return _c
}

func (_c *MeasurementsMock_GetMetricsClient_Call) RunAndReturn(run func() measurement.MetricsObjectClient) *MeasurementsMock_GetMetricsClient_Call {
	_c.Call.Return(run)
	return _c
}
