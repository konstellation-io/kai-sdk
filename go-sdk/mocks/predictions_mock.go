...
// Save provides a mock function with given fields: ctx, predictionID, value
func (_m *PredictionsMock) Save(ctx context.Context, predictionID string, value prediction.Payload) error {
	ret := _m.Called(ctx, predictionID, value)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, prediction.Payload) error); ok {
		r0 = rf(ctx, predictionID, value)
	} else {
		r0 = ret.Error(0)
	}
...
func (_e *PredictionsMock_Expecter) Save(ctx interface{}, predictionID interface{}, value interface{}) *PredictionsMock_Save_Call {
	return &PredictionsMock_Save_Call{Call: _e.mock.On("Save", ctx, predictionID, value)}
}

func (_c *PredictionsMock_Save_Call) Run(run func(ctx context.Context, predictionID string, value prediction.Payload)) *PredictionsMock_Save_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
// Update provides a mock function with given fields: ctx, predictionID, payloadFunc
func (_m *PredictionsMock) Update(ctx context.Context, predictionID string, payloadFunc prediction.UpdatePayloadFunc) error {
	ret := _m.Called(ctx, predictionID, payloadFunc)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, string, prediction.UpdatePayloadFunc) error); ok {
		r0 = rf(ctx, predictionID, payloadFunc)
	} else {
		r0 = ret.Error(0)
	}
...
//   - ctx context.Context
//   - predictionID string
//   - payloadFunc prediction.UpdatePayloadFunc
func (_e *PredictionsMock_Expecter) Update(ctx interface{}, predictionID interface{}, payloadFunc interface{}) *PredictionsMock_Update_Call {
	return &PredictionsMock_Update_Call{Call: _e.mock.On("Update", ctx, predictionID, payloadFunc)}
}

func (_c *PredictionsMock_Update_Call) Run(run func(ctx context.Context, predictionID string, payloadFunc prediction.UpdatePayloadFunc)) *PredictionsMock_Update_Call {
	_c.Call.Run(func(args mock.Arguments) {
