...
#     m_centralized_config.js.key_value.return_value = fake_product_kv
#     m_centralized_config.js.key_value.return_value = fake_workflow_kv
#     m_centralized_config.js.key_value.return_value = fake_process_kv
...
async def test_initialize_ko(m_centralized_config):
    m_centralized_config.js.key_value = Mock(side_effect=Exception)
