...
def test_send_output(m_messaging):
    m_messaging._publish_msg = Mock()
    response = Message()
...
def test_send_output_with_request_id(m_messaging):
    m_messaging._publish_msg = Mock()
    response = Message()
...
def test_send_any(m_messaging):
    m_messaging._publish_any = Mock()
    response = Any()
...
def test_send_any_with_request_id(m_messaging):
    m_messaging._publish_any = Mock()
    response = Any()
    request_id = "test_request_id"
...
def test_send_early_reply(m_messaging):
    m_messaging._publish_msg = Mock()
    response = Message()
...
def test_send_early_exit(m_messaging):
    m_messaging._publish_msg = Mock()
    response = Message()
...
#         ],
#     )
# def test_publish_output(m_messaging, payload, function, expected_call_args):
#     request_id = "test_request_id"
#     expected_response_msg = KaiNatsMessage(
#         RequestId=request_id,
#         payload=payload,
