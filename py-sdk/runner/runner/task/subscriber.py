...
class TaskSubscriber:
    ...
    async def start(self):
        ...
        for _, subject in input_subjects:
            ...
            process_ = self.task_runner.sdk.metadata.get_process().replace(".", "-").replace(" ", "-")
    ...
    async def process_message(self, msg: Msg):
        ...
        assert isinstance(self.task_runner.sdk.metadata, Metadata)
    ...
    async def process_runner_error(self, msg: Msg, error: Exception, request_id: str):
        ...
        await self.task_runner.sdk.messaging.send_error(str(error), request_id)
